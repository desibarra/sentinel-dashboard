...
const results = [
  {
    ...
    desglosePorConcepto: [{concepto: 'Flete'}, {concepto: 'Flete'}], trazabilidadInfo: { exportacion: '01', tieneCartaPorte: 'S?', tieneOrigen: 'CDMX', tieneDestino: 'MTY', tienePlacasUnidad: 'S?', nivelExpediente: 'LOG?STICA SIN SOPORTE ADUANAL', accionRecomendadaMatriz: 'Solicitar Pedimento' }
  },
  {
